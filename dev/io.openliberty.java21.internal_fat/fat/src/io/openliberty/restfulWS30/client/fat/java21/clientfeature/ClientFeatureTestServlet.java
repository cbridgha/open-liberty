 ...
 *******************************************************************************/
package io.openliberty.restfulWS30.client.fat.java21.clientfeature;
...
public class ClientFeatureTestServlet extends FATServlet {
    ...
    @Test
    public void testsetClientExecutor() throws Exception {
        ClientBuilder builder = ClientBuilder.newBuilder();
        //Test VT methods
        builder.executorService(Executors.newVirtualThreadPerTaskExecutor());
