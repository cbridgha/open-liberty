...
A good bug report is one that make it easy for everyone to understand what you were trying to do and what went wrong. Provide as much context as possible so we can try to recreate the issue.....password="testme2"
...
1. Ensure you run a passing local gradle build explained in the [README](README.md#contribute-to-open-liberty) before opening a PR.
